...
> **SPRINT 016B — Property Match Pipeline (2026-08-20):** persisted Property data now flows through the real pipeline — after a Business MATCH a deterministic Property stage selects one Property (or NO_PROPERTY_MATCH) into `property_matches`, drives the Property-aware AI draft context (approved-contacts-only, no fabricated price/availability), and surfaces an immutable Property snapshot + Thai warnings in Human Review. Additive migration `0013`; still no Facebook write / external AI / Telegram. See [docs/sprints/SPRINT-016B](docs/sprints/SPRINT-016B-property-match-pipeline.md), [docs/118](docs/118-property-match-persistence.md).

> **SPRINT 017 — Owner UX Polish (2026-08-21):** a non-technical owner can now self-configure with a guided onboarding checklist, Thai property-type labels, click-to-fix readiness, plain-language contact/policy guidance, an owner match-summary page, the approved contact shown in Human Review, and a property-aware deterministic Mock draft. UX-only; no new migration. See [docs/sprints/SPRINT-017](docs/sprints/SPRINT-017-owner-ux-polish.md), [docs/125](docs/125-owner-onboarding-ux.md).
