...
**LEVEL 2 — Controlled Disposable Facebook Test.** The single supervised write test ([81](81-controlled-facebook-write-test.md)) passes on a disposable account/post. Exit: verified-only success; no duplicate; flags restored; evidence stored; doctor green.

**LEVEL 3 — First Pilot Customer.** One real customer, one business, human-approved comments only. Exit criteria below.
