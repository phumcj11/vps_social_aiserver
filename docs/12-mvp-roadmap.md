...
> **SPRINT 017 — Owner UX Polish (2026-08-21):** guided 7-step onboarding checklist, Thai property-type labels, approved-contact surfaced in Human Review, plain-language contact/policy guidance with recommended defaults, readiness click-to-fix, an owner-facing match-summary page, and a property-aware deterministic Mock draft (persisted facts + approved contact, no fabrication). UX-only; no new migration; no Facebook/AI/Telegram. See [125](125-owner-onboarding-ux.md)-[130](130-review-one-screen-decision.md), [sprints/SPRINT-017](sprints/SPRINT-017-owner-ux-polish.md).
